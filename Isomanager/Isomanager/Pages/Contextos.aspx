...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container mt-5 position-relative">
        ...
        <!-- Definición del Alcance del y objetivo -->
        <div class="col-md-12 mb-4">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Definición del Alcance del Sistema de Gestión</h5>
                    <p>Define el objetivo principal y el alcance del sistema de gestión ISO en tu organización. Esto ayuda a determinar los límites y a especificar los procesos, áreas y departamentos que cubrirá el sistema de gestión.</p>
                    <p>Describe las áreas, procesos y ubicaciones que cubrirá este sistema de gestión. Por ejemplo, puedes incluir departamentos específicos, productos, servicios o áreas geográficas. Este campo ayuda a definir los límites y aplicabilidad de tu sistema.</p>
